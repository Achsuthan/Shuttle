    ...
    if(this.username==null || this.password==null)
    {
      ...
      this.http.get('http://192.168.8.102/CPMAD/Shuttle/templogin.php?username='+this.username+'&temppassword='+this.password).timeout(20000)
          ...
          .subscribe(data =>
          {
            ...
            {
              this.http.get('http://192.168.8.102/CPMAD/Shuttle/Login.php?username='+this.username+'&password='+this.password).timeout(20000)
                  .map(res => res.json())
                  .subscribe(data =>
                  {
      ...
      buttons: [
...

        {
          ...
          handler: data => {
            ...
            this.http.get('http://192.168.8.102/CPMAD/Shuttle/sendmail.php?email='+data.title+"&password="+this.temppassword)
                .map(res => res.json())
                .subscribe(data =>
                {
