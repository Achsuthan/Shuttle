...
export class HomePage {
  ...
  public update()
  {
    ...
    this.http.get('http://172.22.169.251/CPMAD/Shuttle/getvalues.php?id='+this.data.id)
        .map(res => res.json())
        .subscribe(data => {
      ...
      buttons: [
        {
          ...
          handler: data => {
            ...
            this.http.get('http://172.22.169.251/CPMAD/Shuttle/loan.php?id='+this.data.id).timeout(20000)
                .map(res => res.json())
                .subscribe(data => {
