...
export class LoginPage {
  ...
  login()
  {
    ...
    if(this.username==null || this.password==null)
    {
      ...
      this.http.get('http://172.22.170.132/CPMAD/Shuttle/templogin.php?username='+this.username+'&temppassword='+this.password).timeout(20000)
          .map(res => res.json())
          .subscribe(data =>
          {
            this.userstemp = data;
            ...
            {
              this.http.get('http://172.22.170.132/CPMAD/Shuttle/Login.php?username='+this.username+'&password='+this.password).timeout(20000)
                  .map(res => res.json())
                  .subscribe(data =>
                  {
...

        {
          ...
          handler: data => {
            ...
            if(email.test(data.title)){
              ...
              this.http.get('http://172.22.170.132/CPMAD/Shuttle/sendmail.php?email='+data.title)
                  .map(res => res.json())
                  .subscribe(data =>
                  {
                    this.email = data;
